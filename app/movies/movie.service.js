...
var MovieService = (function () {
    ...
    MovieService.prototype.getMovies = function () {
        return this._http.get(this._movieUrl).map(function (response) { return response.json(); }).do(function (data) { return console.log("All: " + JSON.stringify(data)); }).catch(this.handleError);
    };
